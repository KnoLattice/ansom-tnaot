        ...
        <AuthCard
          ...
          description={
            view === "onboarding"
              ...
              : "Master your study materials with AI-powered adaptive learning."
          }
          accent="KNOWLATTICE"
        >
          {view === "onboarding" ? (
            ...
            >
              <TabsList className="grid grid-cols-2 rounded-full bg-[var(--color-canvas)] p-[3px] text-[var(--color-text-secondary)] border border-[var(--color-border-subtle)] h-10">
                <TabsTrigger
                  value="login"
                  className="h-full rounded-full text-sm font-medium transition-all data-[state=active]:bg-[var(--color-accent-primary)] data-[state=active]:text-white data-[state=active]:shadow-sm"
                >
                  Login
                </TabsTrigger>
                <TabsTrigger
