...
export function ChatHistoryDrawer({
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-y-0 left-0 z-50 flex w-[300px] flex-col border-r border-[var(--color-border-subtle)] bg-[var(--color-canvas)] transition-transform duration-300 ease-in-out ${
